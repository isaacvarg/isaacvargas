export const metadata = {
    ...
    image: "/projects/daily-exposure.png",
    description: "Determine the daily exposure to a cosmetic product containing a California Prop. 65 chemical.",
    tags: ['go', 'cli', 'compliance', 'linux'],
    isFeatured: true,
    repoUrl: "https://github.com/isaacvarg/prop-65-daily-exposure"
 }
